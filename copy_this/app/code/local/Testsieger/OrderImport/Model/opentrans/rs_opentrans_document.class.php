<?php
    ...
    class rs_opentrans_document {
         ...
         * Header
         *
         * @var Object (rs_opentrans_document_header)
         */
         ...
         * Summary
         *
         * @var Object (rs_opentrans_document_summary)
         */
         ...
         *
         * @return Object(rs_opentrans_document_header)
         */
         ...
         * Returns summary
         *
         * @return Object (rs_opentrans_document_summary)
         */
